...
description: "개인사업자의 홈택스 전자세금계산서 발급·수정·조회·미수금 점검. 청구/영수·금액·거래처·중복 발급 QA, 청구 건과 입금 대조, 판매채널별 매출·카드/현금영수증·플랫폼 정산·수수료·환불·입금의 수동 검토를 돕는다. 세금계산서 발행, 미수금, 정산금이 매출과 달라, 매출 누락 점검 요청에 사용. Pro 대량 월마감은 설치 시 연결하며 자동 발급 금지."
---
