...
확인일 **2026-09-12 (Asia/Seoul)**. 대상은 무료 6종·Pro 9종의 1인 소규모 개인사업자 안내다. 법인세는 별도 Ultra 향후 계획이며 이번 검증에 포함하지 않는다. 두 버전의 CLI 스킬 폴더에 동봉한 `income-tax-hometax/references/tax-policy.md`(종소세)와 `vat-hometax/references/tax-policy.md`(부가세)의 정책 근거를 함께 확인한다.
...
2026-09-12 재확인: [국세청 학원 2025 귀속 PC 안내](https://www.nts.go.kr/nts/na/ntt/selectNttInfo.do?mi=2286&nttSn=1347986), [주택임대 2025 귀속 PC 안내](https://www.nts.go.kr/nts/na/ntt/selectNttInfo.do?mi=2286&nttSn=1347992). 업종별 세부 내역·검토표 대조와 증빙 구성 중복 주의에 반영했습니다. 공통 안내는 tax-prep-kr/references/exempt-status-report.md에 있습니다. Pro 연간 집계는 입력한 원 단위 금액과 확인기록을 검사하며 세액·간주임대료·신고의무 판정이나 공식 서식 자동 작성은 수행하지 않습니다. 실인증 홈택스 신고·접수는 이번 코드 검증 범위가 아닙니다.
